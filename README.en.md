...
**A management decision team.** Nine roles, one table, one decision.

*فارسی: [README.md](README.md)*
...
Full examples: [Persian council](plugins/shora/skills/shora/examples/meeting-fa.md) ·
[English idea review](plugins/shora/skills/shora/examples/idea-review-en.md) ·
[the same council as a manager page](plugins/shora/skills/shora/examples/meeting-fa.html)
...
- macOS / Linux: `~/.claude/skills/shora`
- Windows: `C:\Users\<you>\.claude\skills\shora`
...
For one project only, put it in `.claude/skills/shora` inside that
project.

### Claude.ai or the API

Upload the contents of `plugins/shora/skills/shora/` as a skill, or paste
`plugins/shora/skills/shora/SKILL.md` into a Project's instructions and attach the
`references/` files.
...
Copy [`templates/org-profile.md`](plugins/shora/skills/shora/templates/org-profile.md)
to `shora.md` in your working folder, and fill in what you know: sector,
